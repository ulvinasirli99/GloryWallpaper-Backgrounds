 ...
 */
  ...
  chooseBottomNavigationbarStateSearchColorTheme(Color color) {
    color =
        Provider.of<Settings>(context!).isDarkMode ? Colors.white : Colors.pink;
    return color;
  }
  ...
  chooseBottomNavigationbarStateCategoryColorTheme(Color color) {
    color =
        Provider.of<Settings>(context!).isDarkMode ? Colors.blue : Colors.orange;
    return color;
  }
  ...
  chooseBottomNavigationbarStatefavoriteColorTheme(Color color) {
    color =
        Provider.of<Settings>(context!).isDarkMode ? Colors.green : Colors.teal;
    return color;
  }
  ...
  chooseSettingTextStyleColor(Color color) {
    color =
        Provider.of<Settings>(context!).isDarkMode ? Colors.white : Colors.black;
    return color;
  }
}
